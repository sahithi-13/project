            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-24 items-start">
              ...
              <div className="flex flex-col space-y-6">
                ...
                >
                  ...
                  <option value="2024-25">FY 2024-25 (AY 2024-25)</option>
                  <option value="2023-24">FY 2023-24 (AY 2023-24)</option>
                  <option value="2022-23">FY 2022-23 (AY 2022-23)</option>
                  <option value="2021-22">FY 2021-22 (AY 2021-22)</option>
                  <option value="2020-21">FY 2020-21 (AY 2020-21)</option>
                </select>
              </div>
                ...
                <div className="h-12">
                  {['old', 'new'].map((type) => (
                    <div
                      ...
                      className={`flex items-center p-5 border rounded-xl cursor-pointer transition-all ${regime === type
                          ? 'border-[#00d29d] bg-white shadow-sm'
                          : 'border-slate-200 bg-white/50 hover:border-slate-300'
                        }`}
                    >
                      <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${regime === type ? 'border-[#00d29d]' : 'border-slate-300'
                        }`}>
                        {regime === type && <div className="w-2.5 h-2.5 bg-[#00d29d] rounded-full" />}
                      </div>
                      <span className={`ml-4 font-bold capitalize ${regime === type ? 'text-slate-900' : 'text-slate-500'
                        }`}>
                        {type} Regime
                      </span>
                    </div>
