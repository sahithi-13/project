...
export default function HUFITRPAGE() {
  ...
  return (
    <div className="flex justify-center animate-in fade-in">
      <div className="w-full max-w-3xl">
        <h2 className="text-[32px] font-bold text-[#4e557d] mb-10 text-center">{title}</h2>
        <p className="text-black font-bold text-xl mb-20 text-center">{question}</p>
