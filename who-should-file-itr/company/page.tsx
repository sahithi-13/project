...
//                         rounded-[2rem] hover:border-[#00a878] hover:bg-[#f0fdfa]"
//                     >
...
//         <p className="font-bold text-xl mb-20 text-center">
//           {question}
//         </p>
...
//             <label
//               key={opt}
//               className="flex items-center p-8 border-2 rounded-2xl cursor-pointer"
//             >
//               <input type="radio" name="q" className="mr-6" />
...
//           {onPrev ? (
//             <button onClick={onPrev} className="flex items-center gap-1">
//               <ChevronLeft size={20} /> Back
//             </button>
//           ) : <div />}
