...
export default function IndividualITRPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-6">
      <div className="bg-white w-full max-w-4xl rounded-[2.5rem] shadow-xl p-12 border border-slate-50 flex flex-col items-center justify-center min-h-[550px]">
          ...
          <>
            ...
            {step === 5 && (
              <div className="text-center py-24 flex flex-col items-center animate-in zoom-in-95 duration-500">
                ...
                <p className="text-slate-500 text-lg max-w-md mb-16">
                  Upload your documents and relax — our tax experts will take it from here.
                </p>

                <div className="flex flex-col items-center gap-14">
                  <button className="flex flex-col items-center gap-3 group">
                    <div className="w-24 h-24 rounded-full bg-[#e6f7f1] flex items-center justify-center text-[#00a878]
                  ...
                  <button
                    ...
                    className="bg-[#00a878] text-white px-16 py-4 rounded-xl font-bold hover:bg-[#00966a]"
                  >
